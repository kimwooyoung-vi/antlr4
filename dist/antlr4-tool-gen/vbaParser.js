...
class vbaParser extends Parser {
    get grammarFileName() { return "vba.g4"; }
    get literalNames() { return vbaParser.literalNames; }
    get symbolicNames() { return vbaParser.symbolicNames; }
    get ruleNames() { return vbaParser.ruleNames; }
    get serializedATN() { return vbaParser._serializedATN; }
...
vbaParser.GUID = 205;
vbaParser.STRINGLITERAL = 206;
vbaParser.OCTLITERAL = 207;
vbaParser.HEXLITERAL = 208;
vbaParser.SHORTLITERAL = 209;
vbaParser.INTEGERLITERAL = 210;
vbaParser.DOUBLELITERAL = 211;
vbaParser.DATELITERAL = 212;
vbaParser.LINE_CONTINUATION = 213;
vbaParser.NEWLINE = 214;
vbaParser.REMCOMMENT = 215;
vbaParser.COMMENT = 216;
vbaParser.SINGLEQUOTE = 217;
vbaParser.COLON = 218;
vbaParser.UNDERSCORE = 219;
vbaParser.WS = 220;
vbaParser.IDENTIFIER = 221;
vbaParser.EOF = Token.EOF;
...
vbaParser.RULE_lineNumber = 51;
vbaParser.RULE_loadStmt = 52;
vbaParser.RULE_lockStmt = 53;
vbaParser.RULE_lsetStmt = 54;
vbaParser.RULE_macroConstStmt = 55;
vbaParser.RULE_macroIfThenElseStmt = 56;
vbaParser.RULE_macroIfBlockStmt = 57;
vbaParser.RULE_macroElseIfBlockStmt = 58;
vbaParser.RULE_macroElseBlockStmt = 59;
vbaParser.RULE_midStmt = 60;
vbaParser.RULE_mkdirStmt = 61;
vbaParser.RULE_nameStmt = 62;
vbaParser.RULE_onErrorStmt = 63;
vbaParser.RULE_onGoToStmt = 64;
vbaParser.RULE_onGoSubStmt = 65;
vbaParser.RULE_openStmt = 66;
vbaParser.RULE_outputList = 67;
vbaParser.RULE_outputList_Expression = 68;
vbaParser.RULE_printStmt = 69;
vbaParser.RULE_propertyGetStmt = 70;
vbaParser.RULE_propertySetStmt = 71;
vbaParser.RULE_propertyLetStmt = 72;
vbaParser.RULE_putStmt = 73;
vbaParser.RULE_raiseEventStmt = 74;
vbaParser.RULE_randomizeStmt = 75;
vbaParser.RULE_redimStmt = 76;
vbaParser.RULE_redimSubStmt = 77;
vbaParser.RULE_resetStmt = 78;
vbaParser.RULE_resumeStmt = 79;
vbaParser.RULE_returnStmt = 80;
vbaParser.RULE_rmdirStmt = 81;
vbaParser.RULE_rsetStmt = 82;
vbaParser.RULE_savepictureStmt = 83;
vbaParser.RULE_saveSettingStmt = 84;
vbaParser.RULE_seekStmt = 85;
vbaParser.RULE_selectCaseStmt = 86;
vbaParser.RULE_sC_Selection = 87;
vbaParser.RULE_sC_Case = 88;
vbaParser.RULE_sC_Cond = 89;
vbaParser.RULE_sendkeysStmt = 90;
vbaParser.RULE_setattrStmt = 91;
vbaParser.RULE_setStmt = 92;
vbaParser.RULE_stopStmt = 93;
vbaParser.RULE_subStmt = 94;
vbaParser.RULE_timeStmt = 95;
vbaParser.RULE_typeStmt = 96;
vbaParser.RULE_typeStmt_Element = 97;
vbaParser.RULE_typeOfStmt = 98;
vbaParser.RULE_unloadStmt = 99;
vbaParser.RULE_unlockStmt = 100;
vbaParser.RULE_valueStmt = 101;
vbaParser.RULE_variableStmt = 102;
vbaParser.RULE_variableListStmt = 103;
vbaParser.RULE_variableSubStmt = 104;
vbaParser.RULE_whileWendStmt = 105;
vbaParser.RULE_widthStmt = 106;
vbaParser.RULE_withStmt = 107;
vbaParser.RULE_writeStmt = 108;
vbaParser.RULE_fileNumber = 109;
vbaParser.RULE_explicitCallStmt = 110;
vbaParser.RULE_eCS_ProcedureCall = 111;
vbaParser.RULE_eCS_MemberProcedureCall = 112;
vbaParser.RULE_implicitCallStmt_InBlock = 113;
vbaParser.RULE_iCS_B_MemberProcedureCall = 114;
vbaParser.RULE_iCS_B_ProcedureCall = 115;
vbaParser.RULE_implicitCallStmt_InStmt = 116;
vbaParser.RULE_iCS_S_VariableOrProcedureCall = 117;
vbaParser.RULE_iCS_S_ProcedureOrArrayCall = 118;
vbaParser.RULE_iCS_S_MembersCall = 119;
vbaParser.RULE_iCS_S_MemberCall = 120;
vbaParser.RULE_iCS_S_DictionaryCall = 121;
vbaParser.RULE_argsCall = 122;
vbaParser.RULE_argCall = 123;
vbaParser.RULE_dictionaryCallStmt = 124;
vbaParser.RULE_argList = 125;
vbaParser.RULE_arg = 126;
vbaParser.RULE_argDefaultValue = 127;
vbaParser.RULE_subscripts = 128;
vbaParser.RULE_subscript_ = 129;
vbaParser.RULE_ambiguousIdentifier = 130;
vbaParser.RULE_asTypeClause = 131;
vbaParser.RULE_baseType = 132;
vbaParser.RULE_certainIdentifier = 133;
vbaParser.RULE_comparisonOperator = 134;
vbaParser.RULE_complexType = 135;
vbaParser.RULE_fieldLength = 136;
vbaParser.RULE_letterrange = 137;
vbaParser.RULE_lineLabel = 138;
vbaParser.RULE_literal = 139;
vbaParser.RULE_type_ = 140;
vbaParser.RULE_typeHint = 141;
vbaParser.RULE_visibility = 142;
vbaParser.RULE_ambiguousKeyword = 143;
vbaParser.RULE_remComment = 144;
vbaParser.RULE_comment = 145;
vbaParser.RULE_endOfLine = 146;
vbaParser.RULE_endOfStatement = 147;
vbaParser.literalNames = [null, "','",
    "';'", "'#'",
    "'.'", "'!'",
    "'%'", "'@'",
    "'$'", "'ACCESS'",
    ...
    null, "'''",
    "':'", "'_'"];
vbaParser.symbolicNames = [null, null,
    null, null,
    null, null,
    null, null,
    null, "ACCESS",
...
vbaParser._serializedATN = [4, 1, 221, 2611, 2, 0, 7, 0,
    ...
    2605, 2607];
vbaParser.DecisionsToDFA = vbaParser._ATN.decisionToState.map((ds, index) => new DFA(ds, index));
